...
import com.bleacher.reportclifford.Data.PhotoMedia
...
class ImageListPresenterTest {
    ...
    @Mock
    private val photoSearch: PhotoSearch? = null
    ...
    fun shouldDisplayConnectionErrorMessageWhenNoInternetAndListingPhotos() {
        ...
        `when`(imageService.listPhotos())
                .thenReturn(Single.error<PhotoSearch>(UnknownHostException()))
    ...
    fun shouldReorderPhotosByDateTaken() {
        ...
        val photoSearchResult = PhotoSearch("", searchResultItems)
